...
function addProduct() {
    ...
    //         // Load lại table để hiển thị nội dung
    //         getProductList();
    ...
    //? Fetch API: Dựa vào Promise => Dễ xài hơn Promise
    //? Phải dùng 2 lần then() để lấy được data
    //? fetch(url, {Chứa các khai báo phương thức})
    //? body: JSON.stringfy(sp) => Dữ liệu đẩy xuống BE
    fetch('https://62e7428c69bd03090f7a48a4.mockapi.io/Products', {
            method: 'POST', // or 'PUT'
            headers: {
